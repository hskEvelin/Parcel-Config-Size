...
angular.
  ...
  component('parcelSize', {
	  ...
	  template:
		  ...
		  '</form>'+
		  '<br />'+
		  '<button id="cfg-size-button" class="w3-btn w3-green" ng-click="$ctrl.calcSize($ctrl.parcel)">Größe berechnen</button><label id="cfg-size-res">Paketgröße: {{$ctrl.parcel.size}}</label> '+
		  '</div>' ,
